...
public:
    ...
    virtual int16_t minimum() { calculate() ; return _minimum; }

    //! The maximum value in the sample set
    virtual int16_t maximum() { calculate() ; return _maximum; }
...
protected:
    ...
    int16_t _maximum;           //!< most recently calculated maximum value
